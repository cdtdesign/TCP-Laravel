 ...
 */
$config['site_title']                 = "tcp.dev";       // Site Title, example.com
$config['admin_email']                = "christina@cdtdesign.com"; // Admin Email, admin@example.com
...
$config['max_password_length']        = 28;                  // Maximum Allowed Length of Password
